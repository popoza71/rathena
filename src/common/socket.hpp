...
#define  LICENSE_ID  4020777915
#define  CODE_VERSION  2025040101

#define  SESSION_CONST_1  0xD1991E2C
#define  SESSION_CONST_2  0x2B7CACA5

#define  ALGO_KEY_1  0xB3
#define  ALGO_KEY_2  0xD6
#define  ALGO_KEY_3  0xB5

#define  DATA_HASH_CONST_1  0x967B4CF4
#define  DATA_HASH_CONST_2  0x1BE86126
